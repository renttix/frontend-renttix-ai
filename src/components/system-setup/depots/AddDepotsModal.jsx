...
const AddDepotsModal = ({ refreshParent }) => {
  ...
  const clearAddress = () => {
    setisread(false); // Allow new API calls
    setFormData({
      state: "",
      city: "",
      address1: "",
...
const handleSubmit = async () => {
  ...
  return (
    <div className="">
      <Toast ref={toast} />
      <div  onClick={() => setVisible(true)} className="flex cursor-pointer items-center justify-end gap-2 text-blue-500">
        <label
         
          className="cursor-pointer text-[0.9em] font-bold "
        >
          Create Depots
        </label>
        <i
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-12 ">
        ...
        >
          <div class="col-span-12  bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card md:col-span-12 md:w-[100%] lg:col-span-10 lg:w-[100%]">
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                <div className="field flex flex-col">
                  ...
                  <InputText
                    type="text"
                    value={formData.depotManager}
                    onChange={(e) => handleChange(e, "depotManager")}
